...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card-custom p-4">
            <h2 class="page-title mb-2">{{ $categoria->nombre }}</h2>
            <p class="text-muted mb-4">{{ $categoria->descripcion }}</p>
            <h5 class="fw-bold mb-3" style="color: var(--vino)">Libros en esta categoría</h5>
